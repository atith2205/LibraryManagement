		...
		<div class="jumbotron login col-lg-10 col-md-11 col-sm-12 col-xs-12">
			...
			<div class="container">
				<form class="form-horizontal" role="form" action="lend-student.php" method="post" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label for="Mname" class="col-sm-2 control-label">MEMBER NAME</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" name="member" id="Mname" value="<?php echo $name; ?>">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label for="borrowDate" class="col-sm-2 control-label">BORROW DATE</label>
						<div class="col-sm-10">
							<input type="date" class="form-control" name="borrowDate" id="borrowDate">
						</div>
					</div>
					<div class="form-group">
						<label for="dueDate" class="col-sm-2 control-label">RETURN DATE</label>
