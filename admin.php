...
session_start();
if (isset($_SESSION['auth']) && ($_SESSION['auth'] === true) && isset($_SESSION['admin'])) {
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form role="form" action="admin.php" method="post">
					<div class="mb-3">
						<label for="News" class="form-label">Publish Announcement</label>
				...
				<form role="form" action="admin.php" method="post" enctype="multipart/form-data">
					<div class="modal-body">
						<div class="input-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
							...
							<input type="text" name="id" value=" <?php echo $row['newsId']; ?>
								">
							<div class="form-group ">
