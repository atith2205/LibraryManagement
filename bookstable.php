...
<div class="container">
	<div class="panel panel-default">
				...
				while ($row = mysqli_fetch_array($query2)) { ?>
					<tbody>
						...
						<form method='post' action='bookstable.php'>
							<input type='hidden' value="<?php echo $row['bookId']; ?>" name='id'>
							<td>
								<button name='del' type='submit' value='Delete' class='btn btn-danger text-white' onclick='return Delete()'>
		...
		<div class="row justify-content-center">
			<div class="col-auto">
				<!-- <a class="btn btn-success px-4 py-2" href="addbook.php"><i class="fas fa-user-plus"></i> Add Books</a> -->
				<a class="btn btn-success px-4 py-2" href="addbook.php">Add Books</a>
			</div>
		</div>
	</div>
</div>
